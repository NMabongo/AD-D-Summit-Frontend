...
const nextScreen = () => {
  ...
  console.log("Navigating to the next screen...", "/registration/registrationAttendanceConfirmation");
            ...
            <View style={[styles.inputContainer, styles.textInputLong]}>
              ...
              <View style={styles.inputIconRow}>
                ...
                <TouchableOpacity onPress={() => setShowPassword(!showPassword)}>
                  <Icon name={showPassword ? "eye-off-outline" : "eye-outline"} size={22} color="#bdbdbd" style={{ marginRight: 10 }} />
                </TouchableOpacity>
              </View>
